    ...
    int paraustuayristir(int para,int urun){
         int i=0,j=0;
            int para_ustu=para-urun;
                       ...
                       printf("%d adet 200 luk barkot \n",i);
                       i=0;
                        while(para_ustu>=100){
                        i++;
                        para_ustu =para_ustu-100;
                        }
                       printf("%d adet 100 luk barkot \n",i);
                       i=0;
                          while(para_ustu>=50){
                        i++;
                        para_ustu =para_ustu-50;
                        }
                       printf("%d adet 50 luk barkot \n",i);
                       i=0;
                          while(para_ustu>=20){
                        i++;
                        para_ustu =para_ustu-20;
                        }
                       printf("%d adet 20 luk barkot \n",i);
                       i=0;
                          while(para_ustu>=10){
                        i++;
                        para_ustu =para_ustu-10;
                        }
                       printf("%d adet 10 luk barkot \n",i);
                       i=0;
                          while(para_ustu>=1){
                        i++;
                        para_ustu =para_ustu-1;
                        }
                       printf("%d adet 1 luk barkot \n",i);
                       i=0;
